...
public class RegistroTransacoesBancarias {
    ...
    public static void main(String[] args) {
        ...
        List<String> trasacoesList = new ArrayList<>();
        ...
        // TODO: Implemente um loop 'for' para iterar sobre as transações:
          for(int i = 0;i<quantidadeTransacoes;i++){
            ...
            if (tipoTransacao == 'D' || tipoTransacao == 'd') {
              ...
              trasacoesList.add(String.format("%d. Deposito de %.1f",i+1, valorTransacao));

            } else if (tipoTransacao == 'S' || tipoTransacao == 's') {
                saldo -= valorTransacao; 
                // TODO: Adiciona a transação à lista
              trasacoesList.add(String.format("%d. Saque de %.1f",i+1, valorTransacao));
        ...
        for(int i = 0; i < trasacoesList.size(); i++){
            // TODO: Agora exibA o número da transação seguido da descrição da transação:
            System.out.println(trasacoesList.get(i));
        }
